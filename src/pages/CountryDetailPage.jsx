...
const handleRandom = () => {
   ...
   return (
     <div className="max-w-md mx-auto card bg-base-100 shadow p-6 text-center space-y-3">
      ...
      <span className="badge">{country.population.toLocaleString()} people
      </span>
    </div>

  <div className="flex gap-2 justify-center pt-2"> 
   <button className="btn btn-ghost" onClick={() => navigate(-1)}>Back
</button>

    <button className="btn btn-primary" onClick={handleRandom}>Random Country
</button>
</div>
</div>
);
